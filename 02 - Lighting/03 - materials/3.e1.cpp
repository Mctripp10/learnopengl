...
//
// Prompt: Can you make it so that changing the light color changes the color of the light's cube object?
// 
// 5-21-2024
...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        lightCubeShader.setVec3("ambient", ambientColor);
        lightCubeShader.setVec3("diffuse", diffuseColor); 
        lightCubeShader.setVec3("specular", 1.0f, 1.0f, 1.0f);
