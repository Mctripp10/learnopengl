...
// Light Casters 4
//
// Implements a spotlight with smoother edges (credit: comment by Andrei Despinoiu)
// 
// 5-30-2024
...
int main()
{
    ...
    // ------------------------------------
    Shader lightingShader("5.1.light_casters.vert", "5.4.spotlight_smoother_edges.frag");
    ...
    unsigned int flashlightText = loadTexture("resources/textures/flashlight.png");
    ...
    lightingShader.setInt("light.flashlight", 2);
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glBindTexture(GL_TEXTURE_2D, flashlightText);
