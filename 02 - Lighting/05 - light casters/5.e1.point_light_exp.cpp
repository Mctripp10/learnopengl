...
//    // ------------------------------------
//    Shader lightingShader("5.1.light_casters.vert", "5.e1.point_light_exp.frag");
...
//        lightingShader.setFloat("light.linear", 0.03f);
//        lightingShader.setFloat("light.quadratic", 0.015f);
//
