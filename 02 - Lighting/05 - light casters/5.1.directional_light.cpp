...
// Light Casters 1
//
// Implements a directional light, a light source that is modeled to be infinitely far away (like the sun)
// Called a directional light since all its light rays have the same direction; 
...
int main()
{
    ...
    // ------------------------------------
    Shader lightingShader("5.1.light_casters.vert", "5.1.directional_light.frag");
