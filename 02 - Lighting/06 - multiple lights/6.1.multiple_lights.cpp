...
//// Multiple Lights 1
////
//// Implements a scene containing multiple different light sources, including
//// 1 direction light, 1 spotlight and 4 point lights
//// 
//// 6-4-2024
//
//// settings
...
//            lightingShader.setVec3(pointLightIndex + "ambient", 0.05f, 0.05f, 0.05f);
//            lightingShader.setVec3(pointLightIndex + "diffuse", 0.8f, 0.8f, 0.8f);
