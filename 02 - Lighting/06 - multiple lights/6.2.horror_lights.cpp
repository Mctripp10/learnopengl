...
glm::vec3 pointLightColor(3.0f, 0.05f, 0.05f);
...
int main()
{
    ...
    Shader lightCubeShader("6.1.light_source.vert", "6.1.light_source.frag");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // Disable directional light for this scene (set ambient, diffuse, and specular to 0)
        ...
        for (unsigned int i = 0; i < 4; i++)
        {
            ...
            lightingShader.setVec3(pointLightIndex + "ambient", 0.0f, 0.0f, 0.0f);
            lightingShader.setVec3(pointLightIndex + "diffuse", pointLightColor);
            lightingShader.setVec3(pointLightIndex + "specular", 0.5f, 0.5f, 0.5f);
            lightingShader.setFloat(pointLightIndex + "constant", 1.0f);
            lightingShader.setFloat(pointLightIndex + "linear", 0.07f);
            lightingShader.setFloat(pointLightIndex + "quadratic", 2.0f);
        }
