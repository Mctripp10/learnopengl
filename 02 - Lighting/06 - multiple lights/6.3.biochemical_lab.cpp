...
//// Multiple Lights 3
//// 
//// Light scene to simulate a biochemical lab
//// Contains 1 directional light and 4 point lights (no flashlight)
////
//// 6-4-2024
//
//// settings
...
//glm::vec3 pointLightColor(0.0f, 1.0f, 0.0f);
//
//int main()
//{
...
//            lightingShader.setVec3(pointLightIndex + "ambient", 0.5f, 0.5f, 0.5f);
...
//        }
//
//        // Disable spotlight for this scene (set ambient, diffuse, and specular to 0)
