...
//    lastY = ypos;
//
//    const float sensitivity = 0.1f;     // mouse would be way too strong without this
//    xoffset *= sensitivity;
//    yoffset *= sensitivity;
//
//    yaw += xoffset;
//    pitch += yoffset;
//
//    if (pitch > 89.0f)      // constraints to prevent camera from looking higher than 89 degrees
//        pitch = 89.0f;
//    if (pitch < -89.0f)
//        pitch = -89.0f;
//
